...
/*   Updated: 2019/12/20 11:03:21 by majosue          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	int		count_w;
	...
	*/
	while (++count_h < WIN_HEIGHT * WIN_WIDTH)
		mlx.img.data[count_h] = 0xFFFFFF;
	
	mlx.img.data[50 * 100 + 50] = 0;
...
int main()
{
    ...
    img_ptr = mlx_xpm_file_to_image (mlx_ptr, "1.xpm", &h, &w);
